...
:root {
  ...
  --border-color: #e8ddd0;
  --card-border: #e8ddd0;
  --shadow-color: rgba(93,13,24,0.10);
...
[data-theme="dark"] .order-item-total { color: var(--gold); }
...
[data-theme="dark"] .btn-confirm { color: var(--bg); }
...
[data-theme="dark"] .btn-link { color: var(--bg); }
